  ...
  const masteryCards = [
    {
      ...
      desc: 'Building end-to-end web and mobile applications, from database architecture to intuitive user interfaces.',
      id: 'ARCH-X'
    },
    {
      icon: <Cpu size={20} />,
      title: 'Performance Engineering',
      desc: 'Optimizing applications for speed, scalability, and smooth real-time user experiences.',
      id: 'PERF-Y'
    },
    {
      icon: <ShieldCheck size={20} />,
      title: 'Secure Architecture',
      desc: 'Implementing authentication, data protection, and secure backend systems in every application.',
      id: 'SEC-Z'
    },
    {
      icon: <Zap size={20} />,
      title: 'Modern Tech Stack',
      desc: 'Working with modern technologies like React, Next.js, Node.js, React Native, Expo, Firebase, and Cloud services.',
      id: 'TECH-A'
    }
  ];
        ...
        >
          ...
          <div className="hologram-card technical-border" style={{ padding: '2.5rem', marginBottom: '2rem', background: 'rgba(0, 245, 255, 0.02)' }}>
            <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '1.05rem', lineHeight: 1.8 }}>
              Full-stack Web and Mobile Developer with <span style={{ color: '#fff', fontWeight: 600 }}>4.5 years of experience</span>
              building scalable, high-performance applications. Specializing in the intersection of
              <span style={{ color: '#fff', fontWeight: 600 }}> Complex Engineering</span> and
              <span style={{ color: '#00f5ff' }}> Human Experience</span>, focused on clean architecture,
              performance, and seamless user experiences.
            </p>

            <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.8 }}>
              Whether architecting high-concurrency backends, crafting responsive web platforms, or developing
              cross-platform mobile applications, each project is built with scalability, performance, and
